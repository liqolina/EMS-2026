...
bool GitHubOtaUpdater::configureSecureClient(NetworkClientSecure &client, const String &url) {
  ...
  if (!_config.strictTls && _config.allowInsecureTlsForTesting) {
    client.setInsecure();
